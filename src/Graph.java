...
public class Graph { 
    ...
    public static void main (String args[]){         
        try{ 
            ...
            teste.insertArc(0, 1, 2);
            teste.insertArc(0, 4, 1);
            teste.insertArc(0, 2, 1);
            
            teste.insertArc(1, 0, 2);
            teste.insertArc(1, 4, 3);
            teste.insertArc(1, 2, 3);
            teste.insertArc(1, 3, 4);
            
            teste.insertArc(2, 0, 1);
            teste.insertArc(2, 1, 3);
            teste.insertArc(2, 3, 2);
            
            teste.insertArc(3, 2, 2);
            teste.insertArc(3, 1, 4);
            teste.insertArc(3, 4, 1);
            
            teste.insertArc(4, 0, 1);
            teste.insertArc(4, 1, 3);
            teste.insertArc(4, 3, 1);
